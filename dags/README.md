...
- `social_analytics_mock_pipeline`: runs mock providers through raw storage, normalization and JSON artifact loading every 15 days, with catchup enabled for historical intervals.
