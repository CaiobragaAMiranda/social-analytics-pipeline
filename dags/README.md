...
- `social_analytics_youtube_pipeline`: runs the real YouTube provider through raw storage, normalization and configurable JSON/PostgreSQL loading every 15 days, using only environment variables for API key, channel and load target.
